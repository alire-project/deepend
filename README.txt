...
There are 4 Storage Pool packages to choose from in Deepend.
  ...
  also finalized. A Basic_Dynamic_Pool can be thought of as a Dynamic_Pool with a single 
  subpool. A Basic_Dynamic_Pool is an unbounded pool such that if the
...
Deepend has been ported to the following compilers and platforms.
   ...
   GNAT AUX FSF 4.6.1  (Android)         Ada95??, Ada2005
