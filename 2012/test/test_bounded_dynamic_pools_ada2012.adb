...
is
   ...
   function New_Ordinary_Type is new
     Bounded_Dynamic_Pools.Initialized_Allocation
       (Ordinary_Type,
        O_Access);

   function New_Reference_Counted_Type is new
     Bounded_Dynamic_Pools.Allocation
...
begin
   ...
   declare
      ...
      Sub_Pool : Bounded_Dynamic_Pools.Scoped_Subpool_Handle
        := Pool.Create_Subpool (Size    => 400);
   ...
   begin
      ...
      declare
         Sub_Pool : Bounded_Dynamic_Pools.Scoped_Subpool_Handle
           := Bounded_Dynamic_Pools.Create_Subpool (Pool, 1000);
      begin
         ...
         for I in 1 .. 10 loop
            declare
               ...
               pragma Compile_Time_Warning
                 (Bounded_Dynamic_Pools.Ada2012_Warnings,
                  "GNAT subpool bug");
