...
--  a means to allocate unconstrained objects from specific subpools.
...
package Dynamic_Pools is
   ...
   pragma Compile_Time_Warning
     (Ada2012_Warnings,
      ...
      "default subpool. Once that is fixed, these generics should no" &
      "longer be needed");
...
private
   ...
   type Dynamic_Pool
     (Default_Block_Size : Storage_Elements.Storage_Count
      := Default_Allocation_Block_Size) is new Root_Storage_Pool_With_Subpools
   with record
